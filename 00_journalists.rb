...
puts "Il y a #{journalists.count} journalistes au total."
puts #saut de ligne

#Quel est le handle le plus court de cette liste ?
shortest = journalists[0]
journalists.each do |i|
    if i.length < shortest.length
        shortest = i
    end
end
puts "#{shortest} est le journaliste  qui a le handle le plus court."
puts #saut de ligne

#Combien y-a-t'il de handle contenant 5 caractères (le @ ne compte pas pour un caractère)
puts "Il y a #{journalists.count { |l| l.length == 6}} handles contenant 5 caractères (sans le @)."
puts #saut de ligne

#Combien commencent par une majuscule (première lettre juste après le @) ?
#puts "Il y a ..... handles qui commencent par une majuscule"
puts #saut de ligne

#Trie la liste de handle par ordre alphabétique.
puts "Voici la liste par ordre alphabétique :"
puts "#{journalists.sort_by {|journalists| journalists.downcase}}"
puts #saut de ligne

#Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)
puts "Voici la liste des handles classés par taille :"
puts journalists.sort_by {|handle| handle.length}
puts #saut de ligne

#Quelle est la position dans l'array de la personne @epenser ?
position = journalists.index("@epenser") + 1
